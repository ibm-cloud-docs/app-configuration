...
# Service dependency map for IBM Cloud App Configuration
...
{: tab-group="service-dependency-data-for-apprapp-Data-and-Control-plane-deployment"}
...
{: row-headers}
{: caption="IBM Cloud App Configuration - Data and Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
...
| {{site.data.keyword.secrets-manager_full}}| Security compliance | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud App Configuration - Data and Control plane deployment service dependency information - Minimal dependencies" caption-side="top"}
...
## NGDC Data and Control plane deployment
{: #ngdc-data-and-control-plane-deployment}
...
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-apprapp-NGDC-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-deps-ngdc-data-and-control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| {{site.data.keyword.messagehub_full}} | Availability, Operations | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud App Configuration - NGDC Data and Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-apprapp-NGDC-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-deps-ngdc-data-and-control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
{: tab-group="service-dependency-data-for-apprapp-NGDC-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #medium-deps-ngdc-data-and-control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| {{site.data.keyword.secrets-manager_full}}| Security compliance | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud App Configuration - NGDC Data and Control plane deployment service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-apprapp-NGDC-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-deps-ngdc-data-and-control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
