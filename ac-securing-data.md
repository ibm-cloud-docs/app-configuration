...
These information can be deleted using the APIs mentioned [here](https://cloud.ibm.com/apis/app-configuration){: external}. Deletion of information is deleted permanently from the service.
...
The {{site.data.keyword.appconfig_short}} data retention policy describes how long your data is stored after you delete the service. The data retention policy is included in the {{site.data.keyword.appconfig_short}} service description, which you can find in the [IBM Cloud Terms and Notices](/docs/overview?topic=overview-terms){: external}.
...
To restore a deleted instance or to delete the instance permanently you can use Resource Reclamations. Refer to [Using resource reclamations](/docs/account?topic=account-resource-reclamation){: external} to know more on the resource reclamation.
