...
![List of segments](images/ac-segments-default.png "List of segments"){: caption="Figure 25. List of segments" caption-side="bottom"}
...
![Overflow menu for a segment](images/ac-segments-overflow-menu.png "Overflow menu for a segment"){: caption="Figure 27. Overflow menu for a segment" caption-side="bottom"}
