...
![List of segments](images/ac-segments-default.png "List of segments"){: caption="Figure 22. List of segments" caption-side="bottom"}
...
1. Click **Create**. The side-panel opens with fields for creating a new segment.
   ...
   ![Create a segment](images/ac-segments-create.png "Creating a segment"){: caption="Figure 23. Creating a new segment" caption-side="bottom"}
...
![Overflow menu for a segment](images/ac-segments-overflow-menu.png "Overflow menu for a segment"){: caption="Figure 24. Overflow menu for a segment" caption-side="bottom"}
