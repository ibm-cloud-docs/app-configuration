...
### Locations where activity tracking events are sent to {{site.data.keyword.logs_full}} hosted event search
{: #at-legacy-locations}


{{site.data.keyword.appconfig_short}} sends activity tracking events to {{site.data.keyword.logs_full}} hosted event search in the regions that are indicated in the following table.
