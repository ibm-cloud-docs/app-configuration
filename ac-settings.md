...
If you are using JavaScript or React SDK, you need to allowlist your domains using the previously mentioned steps or by using {{site.data.keyword.appconfig_short}} API. For more information, see [here](https://{DomainName}/apis/app-configuration#update-originconfigs){: external}.
{: note}
